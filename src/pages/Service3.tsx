import { ArrowLeft, Home, Shield, Video, UserCheck, Siren, CheckCircle2, Phone } from "lucide-react";

const ResidentialCommercialSecurity = () => {
  const features = [
    { icon: Shield, title: "Gated Community Security", desc: "Professional guards for residential complexes and societies" },
    { icon: Video, title: "CCTV Monitoring", desc: "24/7 surveillance with real-time monitoring capabilities" },
    { icon: UserCheck, title: "Visitor Management", desc: "Secure entry systems with visitor verification and logging" },
    { icon: Siren, title: "Patrol Services", desc: "Regular patrolling to ensure complete premises security" }
  ];

  const benefits = [
    "Trained security personnel for residential areas",
    "Visitor registration and verification systems",
    "24/7 CCTV surveillance and monitoring",
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center space-y-6 px-4 max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-white/95 max-w-2xl mx-auto leading-relaxed drop-shadow-lg">
              Creating Safe Living and Shopping Environments
            </p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#cf150e]/10 rounded-full border border-[#cf150e]/20">
                <Home className="w-4 h-4 text-[#cf150e]" />
              ...
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p className="border-l-4 border-[#cf150e] pl-6 italic">
                  Your home and business deserve the highest level of protection. Our residential and commercial security services provide peace of mind through professional guards, advanced technology, and proven security protocols.
                </p>
                
                <p>
                  We specialize in securing residential communities, apartment complexes, shopping centers, and commercial establishments. Our trained security personnel understand the importance of creating a safe environment while maintaining a welcoming atmosphere for residents, customers, and visitors.
                </p>
                
                <p className="bg-[#cf150e]/5 p-6 rounded-lg border-l-4 border-[#cf150e]">
                  With our integrated security systems including visitor management, CCTV surveillance, and patrol services, we ensure complete protection for your property and the people within it.
                </p>
              </div>
            </div>
    ...
    Request a Quote
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Advanced solutions for residential and commercial protection
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              <h3 className="text-3xl font-bold mb-6 text-gray-900">What We Offer</h3>
...
export default ResidentialCommercialSecurity;