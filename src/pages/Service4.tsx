import { ArrowLeft, Factory, Sparkles, Wrench, Trash2, ClipboardCheck, CheckCircle2, Phone } from "lucide-react";

const FacilityHousekeeping = () => {
  const features = [
    { icon: Sparkles, title: "Cleaning Services", desc: "Professional cleaning for all types of facilities and premises" },
    { icon: Wrench, title: "Maintenance Support", desc: "Routine maintenance and upkeep of building facilities" },
    { icon: Trash2, title: "Waste Management", desc: "Efficient waste collection and disposal systems" },
    { icon: ClipboardCheck, title: "Quality Control", desc: "Regular inspections and quality assurance protocols" }
  ];

  const benefits = [
    "Trained and professional housekeeping staff",
    "Customized cleaning schedules and protocols",
    "Use of eco-friendly cleaning products",
    "Deep cleaning and sanitization services",
    "Pantry and washroom maintenance",
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center space-y-6 px-4 max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-white/95 max-w-2xl mx-auto leading-relaxed drop-shadow-lg">
              Professional Management for Pristine Environments
            </p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#cf150e]/10 rounded-full border border-[#cf150e]/20">
                <Factory className="w-4 h-4 text-[#cf150e]" />
              ...
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p className="border-l-4 border-[#cf150e] pl-6 italic">
                  A clean and well-maintained facility reflects professionalism and creates a positive impression. Our comprehensive facility and housekeeping management services ensure your premises are always at their best.
                </p>
                
                <p>
                  We provide end-to-end facility management solutions including professional cleaning, maintenance, waste management, and quality control. Our trained staff follows strict protocols to maintain hygiene standards and ensure a healthy environment for your employees, customers, and visitors.
                </p>
                
                <p className="bg-[#cf150e]/5 p-6 rounded-lg border-l-4 border-[#cf150e]">
                  From daily cleaning routines to specialized deep cleaning services, we customize our approach based on your facility's unique requirements and operational schedules.
                </p>
              </div>
            </div>
            ...
            <div className="lg:sticky lg:top-8">
              <div className="bg-white p-8 rounded-2xl shadow-2xl border border-gray-200">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Schedule a Service</h3>
    ...
    Request a Quote
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Comprehensive facility management and housekeeping solutions
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              <h3 className="text-3xl font-bold mb-6 text-gray-900">Service Highlights</h3>
            ...
            <div className="bg-gradient-to-br from-[#cf150e]/5 to-[#8b0e08]/5 p-8 rounded-2xl border border-[#cf150e]/20">
              <h3 className="text-3xl font-bold mb-6 text-gray-900">Ideal For</h3>
...
export default FacilityHousekeeping;